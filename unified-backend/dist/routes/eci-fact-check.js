...
import { z } from 'zod';
import ECIFactChecker, { ECICandidateVerifier, ECIResultsVerifier, MyGovIntegration, MisinformationAlertSystem } from '../services/eci-fact-checker.js';
const router = Router();
// Validation schemas
...
router.get('/official-news', async (req, res) => {
    try {
        const category = req.query.category || 'ELECTION';
