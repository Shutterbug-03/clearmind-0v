...
async function generateAISummary(scanResult: any, inputText: string, contentType: string) {
...
function generateIntelligentFallback(scanResult: any, inputText: string, contentType: string) {
...
function generateOverview(confidence: number, verdict: string, contentType: string): string {
